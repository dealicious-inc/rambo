(() => {
  ...
  // js/app.js
  channel.join().receive("ok", (resp) => console.log("\u2705 Joined", resp)).receive("error", (err) => console.error("\u274C Failed", err));
